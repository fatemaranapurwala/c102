...
from_dir = "C:/Users/ranap/Downloads"
to_dir = "C:/Users/ranap/Downloads"
...
for file_name in list_of_files:
    ...
    if extension in ['.pdf']:
        ...
        path2 = to_dir + '/' + "pdf_folder"                     # Example path2 : D:/My Files/Image_Files      
        path3 = to_dir + '/' + "pdf_folder" + '/' + file_name   # Example path3 : D:/My Files/Image_Files/ImageName1.jpg
        #print("path1 " , path1)
        #print("path3 ", path3)
